...
const Perfil_Post_View : React.FC = (props:any) => {
    ...
    const Post_Status = ()=>{
        ...
        return(
            <div className={classname}>
                <p className="perf-Post_Status_text">{props.status ? props.status : "Status"}</p>
            </div>
        )
    }
    const show_manage = ()=>{
        ...
        <div className="perf-Perfil_Post">
            <div className="perf-row">
                ...
                <div className="perf-column_start">
                    <p className="perf-post_view_text">{props.nome ? props.nome : "Nome"}</p>
                    <p className="perf-small">{props.date ? props.date : "X"} dias atras</p>
                </div>
            </div>
